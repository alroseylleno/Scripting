...
strEM= UserInput( "Enable Extension Mobility Function? (YES or NO):" )
...
MyEmail.TextBody="Dear Global Service Desk," &vbCrLf& vbCrLf& "Kindly help granting access for user to these following applications:" &vbCrLf&vbCrLf& "NT Account: " &struseraccount &vbCrLf& "E-mail: " &struseremail &vbCrLf& "Line Manager's E-mail: " &struseremail1 &vbCrLf& "IP extension number: " &struserextension &vbCrLf&vbCrLf& "Access Jabber: " &strJabber &vbCrLf&  "Access VPN Junos Pulse Secure: " &strVPN  &vbCrLf& "Access WebEx permission to host a meeting: " &strwebex &vbCrLf&  "Enable Extension Mobility Function: " &strEM &vbCrLf&vbCrLf& "Best Regards," &vbCrLf&"OSS VN HOCHIMINH" &vbCrLf&"VanLong Truong"
